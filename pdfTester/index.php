...
<script type="text/javascript">
  ...
  <div class="call-to-action-signup" id="Register">
    <div class="container">
      ...
      <form method="post" action="createpdf.php" class="form-inline justify-content-center">
          <div class="row mt-4">
         <div class="col-md-4">
...
<input class="input" type="date" name="REG_DATE" placeholder="yyyy-mm-dd" value="<?php echo date("Y-m-d");?>" hidden>
        ...
        <div class="col-md-4">
        <div class="form-group">
          <select name="CATEGORY" class="custom-select" onChange="showOther(this.value)" required >
