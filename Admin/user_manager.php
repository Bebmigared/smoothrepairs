...
<label for="REG_DATE">Unique ID:</label>
<input class="form-control" type="text" name="UIDS" value="<?php echo  $row1['UID'] ?>" readonly>
</div>
<div class="form-group">
<label for="REG_DATE">Date Registered:</label>
<input class="form-control" type="date" name="REG_DATE" value="<?php echo  $row1['REG_DATE'] ?>" readonly>
</div>
<div class="form-group">
<label id="DKU">Document Uploads</label>
</div>
<div class="form-group">
<label for="FIRST_NAME">First Name</label>
<input class="form-control" type="text" name="FIRST_NAME" id="txtbx" value="<?php echo  $row1['FIRST_NAME'] ?>" >
</div>
<div class="form-group">
<label for="LAST_NAME">Last Name</label>
<input class="form-control" type="text" name="LAST_NAME" id="txtbxs" value="<?php echo  $row1['LAST_NAME'] ?>" >
<input type="text" name="UID" value="<?php echo  $row1['UID'] ?>" hidden>
<input type="text" name="PASSWORD" value="<?php echo  $row1['PASSWORD'] ?>" style="margin-left: 10px; border: transparent;" hidden>
<input type="text" id="TYP" name="ARTISAN_TYPE" value="<?php echo  $row1['ARTISAN_TYPE'] ?>"  hidden>
<input type="text" name="LONGITUDE" id="LONGITUDE" hidden>
<input type="text" name="LATITUDE" id="LATITUDE" hidden>
</div>
<div class="form-group">
<label for="GENDER">Gender</label>
<input class="form-control" type="text" name="GENDER" id="txtbx" value="<?php echo  $row1['GENDER'] ?>" >
</div>
<div class="form-group">
<label for="QUALIFICATION">Qualification</label>
<!--<input class="form-control" type="text" name="QUALIFICATION" id="txtbx" value="<php echo  $row1['QUALIFICATION'] ?>" >-->
...
<!--<input class="form-control" type="text" name="EXPERIENCE" id="txtbx" value="<php echo  $row1['EXPERIENCE'] ?>" >-->
...
<input class="form-control" type="text" name="USERNAME" id="txtbxs" value="<php echo  $row1['USERNAME'] ?>" oninput="this.className = ''" >
</div>-->
<div class="form-group">

<select class="form-control" name="USER_TYPE" id="USER_TYPE" placeholder="Select User Type..." style="visibility:hidden;">
...
<input class="form-control" type="text" name="ADDRESS_LINE_1" value="<php echo  $row1['ADDRESS_LINE_1'] ?>" id="txtbx" oninput="this.className = ''" >
</div>
<div class="form-group">
<label for="ADDRESS_LINE_2">Nearest Bus Stop</label>
<input class="form-control" type="text" name="ADDRESS_LINE_2" value="<php echo  $row1['ADDRESS_LINE_2'] ?>" id="txtbxs" oninput="this.className = ''"  >
</div>
<div class="form-group">
<label for="CITY">City or Town</label>
<input class="form-control" type="text" name="CITY" id="CITY" value="<php echo  $row1['CITY'] ?>" oninput="this.className = ''" onchange="function()" >
</div>-->
<div class="form-group">
<label for="STATE">State</label>
<!--<input class="form-control" type="text" name="STATE" id="STATE" value="<php echo  $row1['STATE'] ?>"  >-->
...
<input class="form-control" type="text" name="MOBILE" id="txtbxs" value="<?php echo  $row1['MOBILE'] ?>" >
</div>
<div class="form-group">
<label for="EMAIL">E-mail Address</label>
<input class="form-control" type="text" name="EMAIL" value="<?php echo  $row1['EMAIL'] ?>" id="txtbx" >
...
<textarea class="form-control" name="ADMIN_COMMENTS" rows="4" col="50"><?php echo  $row1['ADMIN_COMMENTS'] ?></textarea>
...
<input id="submitb" class="btn btn-default" name="submitb" type="submit" value="Back"><input class="btn btn-default" id="submit" name="submit" type="submit" value="Update">
</fieldset>
</div><!--
<div class="form-group">
<fieldset id="F_PP">
...
?>
        ...
        //Not submitting this to DB
        $USER_TYPE=$_POST['USER_TYPE'];
        

        $query = mysql_query("UPDATE Users SET FIRST_NAME='$FIRST_NAME',LAST_NAME='$LAST_NAME',REG_DATE='$REG_DATE',ADMIN_COMMENTS='$ADMIN_COMMENTS',GENDER='$GENDER',STATE='$STATE',EXPERIENCE='$EXPERIENCE',QUALIFICATION='$QUALIFICATION',EMAIL='$EMAIL',CATEGORY='$CATEGORY',MOBILE='$MOBILE',STATUS='$STATUS' WHERE UID='$UID'") or die(mysql_error($db));
