...
?>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class=""><?php echo $_SESSION['last_login'];?></div>
                                    <?php include ("function.php");?>
                                    <div><?php $timeago=get_timeago(strtotime($_SESSION['last_login']));
                                    echo $timeago;?>
                                    </em></div>
                                    <div>Last Login!</div>
                                </div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right"><?php
                                    include("srconfig.php");
                                    $sql1a = "SELECT COUNT(*) AS Total FROM Users WHERE USER_TYPE='Artisan' AND STATUS='0'";
	   ...
	   echo "error occured getting all Artisans ".mysqli_error($conn);
   }
?>
