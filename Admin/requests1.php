                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="blank.html">View All Categories</a>
                                </li>
                                <li>
...
<select class="form-control" name="ARTSN" placeholder="Select User Type..." oninput="this.className = ''">
...
?> 
 <tr><td></td>
                        <td></td><td></td><td></td><td></td><td></td><td><a href="#">Add User</a></td><td><a href="/Admin">Back to Dashboard</a></td>
