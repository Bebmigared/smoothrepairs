...
?>
    ...
    ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">New Category Listing - SmoothRepairs</h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<input class="form-control" type="text" name="category_name" id="txtbx" placeholder="Add new professional service..." required>
</div>
<div class="form-group">
<label for="Category_Desc">Short Description</label>
<input class="form-control" type="text" name="category_desc" id="txtbxs" placeholder="Place short description..." required>
</div>
<div class="form-group">
...
<input class="form-control"  type="file" name="category_image" accept="image/*" required>
<div class="form-group">
</div>
</fieldset>
</div>
	 ...
	 if(empty($_POST['cat_type'])){
		...
		if($error){
		  ...
		  echo "</div>"; 
			...
			$imagePath = '../../img1/'.$_FILES['category_image']['name'] ;
			
			if (file_exists($imagePath)) {
			echo "Sorry, file already exists.";
			}
			
 		else if (copy($_FILES['category_image']['tmp_name'], $imagePath)){
			$sql01 = mysql_query("INSERT INTO Options (DESCRIPTION,CATEGORY,OPTION_NAME,image_link)VALUES('$cat_name','$cat_type','$cat_desc','$imagePath')");
		         if($sql01){
