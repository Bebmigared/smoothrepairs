...
curl_setopt(
  $ch, CURLOPT_HTTPHEADER, ['Authorization: pk_test_e6081be0199b85660e2f466dab4dab608d43c828']
  //$ch, CURLOPT_HTTPHEADER, ['Authorization: pk_live_61cbf727786a5c521a98990828f66b7e6dac6c97']
);
//send request
