...
include("sbconfig.php");
$sql = "SELECT * FROM request_form WHERE request_id= '$PayPlan'";
...
if (mysqli_num_rows($result) != 0) {
        ...
        $_SESSION['PayPlan'][] = $row;
        //echo $_SESSION['PayPlan'][0];
        $PlanType = $_SESSION['PayPlan'][0]['service_type'];
    ...
    <div class="col-md-12 col-md-offset-3">
        <form id="msform" action="" method="post">
			...
			<fieldset>
                ...
                <span for="first_name">Name: </span><input type="text" name="first_name" value="<?=$_SESSION['PayPlan'][0]['fullname'];?>" id="first_name" disabled / >
                <span>Email: </span><input type="text" name="email" value="<?=$_SESSION['PayPlan'][0]['email'];?>" disabled />
                <span>Phone: </span><input type="text" name="mobile" value="<?=$_SESSION['PayPlan'][0]['mobile'];?>" id="mobile" disabled />
                <span>Location: </span><input type="text" name="location" value="<?=$_SESSION['PayPlan'][0]['location'];?>" id="location" disabled />
                <span>Request Details: </span><input type="text" name="service_type" value="<?=$_SESSION['PayPlan'][0]['service_type'];?>" id="service_type" disabled />
			<textarea rows="3" name="details" id="details"disabled ><?=$_SESSION['PayPlan'][0]['messages'];?></textarea>
			<textarea rows="3" name="details" id="details"disabled ><?=$_SESSION['PayPlan'][0]['details'];?></textarea>
			<br>
			<!--<input name="email" id="email" value="<?=$_SESSION['PayPlan'][0]['email'];?>" type="text" hidden>-->
...
function payWithPaystack(){
    ...
    var handler = PaystackPop.setup({
     ...
     //key: 'pk_test_152fc0d1d5b76e4291a4cadc0b7d0c969e04ce16',
           // pk_live_61cbf727786a5c521a98990828f66b7e6dac6c97
