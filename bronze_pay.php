    ...
    <div class="col-md-12 col-md-offset-3">
        <form id="msform" action="" method="post">
			...
			<fieldset>
                ...
                <h3 class="fs-subtitle">Confirm Subscription details and make payment of <strong style="color:red;">N50,000</strong></h3>
...
if(isset($_POST['submit'])){
        ...
        $subject = "SmoothRepairs New Bronze Plan Subscription Payment for $ORIGINATOR ";
        
       //Admin Notification
        $message2 = "
        <html>
        <head>
        <title>SmoothRepairs Bronze Plan Subscription Payment Notification</title>
        </head>
        <body>
        <p>Dear Admin,</p>
        <p>There is a new Bronze Plan Subscription Payment of $Price with pending Confirmation from <strong>$ORIGINATOR</strong>.</p>
